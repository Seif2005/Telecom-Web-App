...
{
    public partial class Cashback_Wallet_Customer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connStr))
                {
                    ...
                    using (SqlCommand command2 = new SqlCommand("SELECT * FROM Cashback_Wallet_Customer(@nationalId)", connection))
                    {

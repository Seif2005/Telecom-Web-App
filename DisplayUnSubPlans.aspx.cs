...
{
    public partial class DisplayUnSubPlans : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connStr))
                {
                    ...
                    using (SqlCommand command2 = new SqlCommand("Exec Unsubscribed_Plans @mobile_num = @mobileNo", connection))
                    {
